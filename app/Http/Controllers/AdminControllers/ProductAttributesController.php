...
class ProductAttributesController extends Controller
{
    ...
    {
        $title = Lang::get("labels.attributes");
        $result = array();
        $result['attributes'] = $this->productsattribute->display($request);
        $result['commonContent'] = $this->Setting->commonContent();        
        return view("admin.products_attributes.index", ["title"=>$title])->with('result', $result);
    }

    public function add(Request $request)
    {
        $title = Lang::get("labels.AddOptions");
        $result = array();
        $result['languages'] = $this->myVarsetting->getLanguages();
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.products_attributes.add", ["title"=>$title])->with('result', $result);
    }
    ...
    {
        $title = Lang::get("labels.Manage Options");
        $result = $this->productsattribute->edit($request);
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.products_attributes.edit", ["title"=>$title])->with('result', $result);
    ...
    public function displayoptionsvalues(Request $request)
    {
        ...
        return view("admin.products_attributes.options.index", ["title"=>$title])->with('result', $data);
    ...
    public function editoptionsvalues(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.products_attributes.options.edit", ["title"=>$title])->with('result', $result);
    }
