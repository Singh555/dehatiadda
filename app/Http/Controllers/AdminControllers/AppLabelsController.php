...
class AppLabelsController extends Controller
{
    ...
    public function listingAppLabels(Request $request)
    {
        ...
        $title = Lang::get("labels.ListingLabels");
        ...
        $labels = DB::table('labels')
            ...
            ->where('labels.title','!=','null')
            ->get();

        $result['message'] = $message;
        $result['labels'] = $labels;  
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.settings.app.labels.listingAppLabels", ["title"=>$title])->with('result', $result);
    ...
    {
        $title = Lang::get("labels.ManageLabel");
        ...
        $result['labels'] = $data;  
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.settings.app.labels.manageAppLabel", ["title"=>$title])->with('result', $result);
    ...
    public function addappkey(Request $request)
    {
        ...
        $title = Lang::get("labels.AddKeyLabel");

        $result = array();
        $message = array();  
        $result['commonContent'] = $this->Setting->commonContent();

        return view("admin.settings.app.labels.addappkey", ["title"=>$title])->with('result', $result);
    ...
    {
        $title = Lang::get("labels.EditLabel");
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.settings.app.labels.editAppLabel", ["title"=>$title])->with('result', $result);
    }
