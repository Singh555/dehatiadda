...
class PagesController extends Controller
{
    ...
    {
        $title = Lang::get("labels.Pages");
        $result = Pages::pages(); 
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.pages.index", ["title"=>$title])->with('result', $result);
    ...
    public function addpage(Request $request)
    {
        ...
        $title = Lang::get("labels.AddPage");
        $result = Pages::addpage(); 
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.pages.add", ["title"=>$title])->with('result', $result);
    ...
    public function editpage(Request $request)
    {
        ...
        $title = Lang::get("labels.EditPage");
        $result = Pages::editpage($request); 
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.pages.edit", ["title"=>$title])->with('result', $result);
    ...
    public function webpages(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.pages.webpages.index", ["title"=>$title])->with('result', $result);
    ...
    public function addwebpage(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.pages.webpages.add", ["title"=>$title])->with('result', $result);
    ...
    public function editwebpage(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.pages.webpages.edit", ["title"=>$title])->with('result', $result);
    }
