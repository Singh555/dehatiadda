...
class PaymentMethodsController extends Controller
{
    ...
    public function index(Request $request){
        $title = Lang::get("labels.PaymentSetting");
        $result = array();
        $result['methods'] = $this->Payments_setting->paymentmethods();
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.paymentmethods.index", ["title"=>$title])->with('result', $result);
    }
    ...
    public function display($id){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.paymentmethods.display", ["title"=>$title])->with(['result' => $result,'id'=> $id]);
    }
