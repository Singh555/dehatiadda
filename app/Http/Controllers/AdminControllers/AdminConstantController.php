...
class AdminConstantController extends Controller
{
    ...
    {
        $title = Lang::get("labels.ListingConstantBanners");
        ...
        return view("admin.settings.web.banners.index", ["title"=>$title])->with(['result' => $result, 'bannerType'=>$bannerType]);
    }

    public function addconstantbanner(Request $request)
    {
        $title =  Lang::get("labels.AddConstantBanner");
        ...
        return view("admin.settings.web.banners.add", ["title"=>$title])->with(['result' => $result, 'allimage' => $allimage]);
    }
    ...
    public function editconstantbanner(Request $request)
    {
        ...
        return view("admin.settings.web.banners.edit", ["title"=>$title])->with(['result' => $result, 'allimage' => $allimage]);
    }
