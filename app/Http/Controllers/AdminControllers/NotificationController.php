...
class NotificationController extends Controller
{
    ...
    {
        $title = Lang::get("labels.ListingDevices");
        $result = array();
        $message = array();
        $errorMessage = array();
        ...
        return view("admin.Notifications.devices", ["title"=>$title])->with('result', $result);
    }
    ...
    public function viewdevices(Request $request)
    {
        ...
        $title = Lang::get("labels.ViewDevice");
        $result = array();
        ...
        $result['devices'] = $devices;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.Notifications.viewdevices", ["title"=>$title])->with('result', $result)->with('allimage', $allimage);
    }
    ...
    public function notifications(Request $request)
    {
        $images = new Images;
        $allimage = $images->getimages();
        $title = Lang::get("labels.SendNotifications");
        $result = array();
        $result['message'] = array();
        $result['commonContent'] = $this->Setting->commonContent();

        return view("admin.Notifications.notifications", ["title"=>$title])->with('result', $result)->with('allimage', $allimage);
    }
