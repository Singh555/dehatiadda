...
class CouponsController extends Controller
{
    ...
    public function display(Request $request)
    {
        ...
        $title = Lang::get("labels.ListingCoupons");
        $result = array();
        $message = array();
        ...
        return view("admin.coupons.index", ["title"=>$title])->with('result', $result)->with('coupons', $coupons);
    ...
    public function filter(Request $request)
    {
        ...
        $result['currency'] = $this->myVarSetting->getSetting();
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.coupons.index", ["title"=>$title])->with('result', $result)->with('coupons', $coupons)->with('name', $name)->with('param', $param);
    }

    public function add(Request $request)
    {

        $title = Lang::get("labels.AddCoupon");
        $result = array();
        $message = array();
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.coupons.add", ["title"=>$title])->with('result', $result);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $title = Lang::get("labels.EditCoupon");
        $result = array();
        $message = array();
        $result['message'] = $message;
        //coupon
        ...
        $result['categories'] = $categories;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.coupons.edit", ["title"=>$title])->with('result', $result);
    }
