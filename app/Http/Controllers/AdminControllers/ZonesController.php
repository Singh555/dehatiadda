...
class ZonesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("admin.zones.index", ["title"=>$title])->with('result', $result)->with('zones', $zones);
    }
    ...
    public function add(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.zones.add", ["title"=>$title])->with('result', $result);
    }
    ...
    public function edit(Request $request)
    {
        ...
        $result['zones'] = $zones;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.zones.edit", ["title"=>$title])->with('result', $result);
    }
    ...
    public function filter(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.zones.index", ["title"=>$title])->with('result', $result)->with('zones', $zones)->with('name', $name)->with('param', $param);
    }
