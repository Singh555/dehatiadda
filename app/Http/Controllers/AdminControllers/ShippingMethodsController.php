...
class ShippingMethodsController extends Controller
{
    ...
    {
        $title = Lang::get("labels.ShippingMethods");
        ...
        return view("admin.shippingmethods.index", ["title"=>$title])->with('result', $result);
    ...
    public function upsShipping(Request $request)
    {
        ...
        $title = Lang::get("labels.UPSShipping");
        $pickupType = '01';
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.shippingmethods.upsshipping", ["title"=>$title])->with('result', $result);
    }

    public function flaterate(Request $request)
    {
        $title = Lang::get("labels.FlateRate");
        ...
        $result['description'] = $description_data;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.shippingmethods.flateRate", ["title"=>$title])->with('result', $result);
    ...
    public function detail(Request $request)
    {
        ...
        return view("admin.shippingmethods.detail", ["title"=>$title])->with('result', $result);

    }

    public function update(Request $request)
    {
        $title = Lang::get("labels.EditMainCategories");
