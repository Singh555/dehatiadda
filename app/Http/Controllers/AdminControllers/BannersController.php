...
class BannersController extends Controller
{
    ...
    {
        $title = Lang::get("labels.ListingBanners");
        ...
        return view("admin.Banners.index", ["title"=>$title])->with('result', $result);
    }
    ...
    public function addbanner(Request $request)
    {
        ...
        $title = Lang::get("labels.AddBanner");
        ...
        return view("admin.Banners.add", ["title"=>$title])->with('result', $result)->with('allimage', $allimage);
    }
    ...
    public function editbanner(Request $request)
    {
        $images = new Images;
        $allimage = $images->getimages();
        $title = Lang::get("labels.EditBanner");
        $result = array();
       ...
       $categories = DB::table('categories')
        ...
        return view("admin.Banners.edit", ["title"=>$title])->with('result', $result)->with('allimage', $allimage);
    }
    ...
    public function updateBanner(Request $request)
    {
        ...
        Log::debug(__CLASS__."::".__FUNCTION__."Called with type $type and url $banners_url");
    ...
    public function filterbanners(Request $request)
    {
        ...
        return view("admin.Banners.index", ["title"=>$title])->with('result', $result)->with('name', $name)->with('param', $param);
    ...
    public function homeSection(Request $request)
    {
        ...
        $banners = DB::table('home_sections')->where('status','1')->paginate(20);
        ...
        return view("admin.Banners.homesection", ["title"=>$title])->with('result', $result);
    }
    ...
    {
        $language_id = 1;
        $title = Lang::get("labels.AddNewHomeSection");
        ...
        return view("admin.Banners.addHomesection", ["title"=>$title])->with('result', $result);
    }
    ...
    public function addNewHomeSection(Request $request)
    {
        ...
        if ($type == 'category' && $request->filled('categories_id')) {
            $ids = implode(",",$request->categories_id);
        } else if ($type == 'product' && $request->filled('products_id')) {
            $ids = implode(",",$request->products_id);
        } else {
            $ids = '';
        }

        $section = DB::table('home_sections')->insert([
            'title'  		 =>   $request->title,
        ...
        $message = Lang::get("labels.HomeSectionAddedMessage");
        return redirect()->back()->withErrors([$message]);
    }

    //editTaxClass
    public function editHomeSection(Request $request)
    {
        $title = Lang::get("labels.EditBanner");
        $result = array();
        $result['message'] = array();
        $language_id = 1;
        $banners = DB::table('home_sections')
        ...
        return view("admin.Banners.editHomeSection", ["title"=>$title])->with('result', $result);
    }
    ...
    public function updateHomeSection(Request $request)
    {
        ...
        $bannersUpdate = DB::table('home_sections')->where('id', $request->id)->update([
        ...
        $message = Lang::get("labels.HomeSectionUpdatedMessage");
    ...
    {
        $deletebanners =  DB::table('home_sections')->where('id', $request->id)->delete();
        return redirect()->back()->withErrors([Lang::get("labels.HomeSectionDeletedMessage")]);
    }
