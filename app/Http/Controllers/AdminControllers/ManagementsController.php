...
class ManagementsController extends Controller
{
  ...
  public function merge(Request $request){
    $title = Lang::get("labels.Merge Project");
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.managements.merge", ["title"=>$title])->with('result',$result);
  }

  public function backup(Request $request){
    $title = Lang::get("labels.Back Up / Restore");
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.managements.backup", ["title"=>$title])->with('result',$result);
  }
  ...
  public function import(Request $request){
    $title = Lang::get("labels.Import Data");
    
    $result['commonContent'] = $this->Setting->commonContent();
    return view("admin.managements.import", ["title"=>$title])->with('result',$result);
  }
