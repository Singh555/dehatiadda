...
class LanguageController extends Controller
{
    ...
    {
        $title = Lang::get("labels.ListingLanguages");
        $result = array();
        $languages = $this->language->paginator();
        $result['languages'] = $languages;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.languages.index", ["title"=>$title])->with('result', $result);
    }
    ...
    public function add(Request $request)
    {
        ...
        $title = Lang::get("labels.AddLanguage");
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.languages.add", ["title"=>$title])->with('allimage', $allimage)->with('result', $result);
    }
    ...
    {
        $allimage = $this->images->getimages();
        $title = Lang::get("labels.EditLanguage");
        $languages = $this->language->edit($request);
        $result['languages'] = $languages;        
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.languages.edit", ["title"=>$title])->with('result', $result)->with('allimage', $allimage);
    }
    ...
    public function filter(Request $request)
    {
        ...
        $result['languages'] = $Languages;        
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.languages.index", ["title"=>$title])->with('result', $result)->with('filter', $filter)->with('parameter', $parameter);
