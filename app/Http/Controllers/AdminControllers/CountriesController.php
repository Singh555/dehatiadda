...
class CountriesController extends Controller
{
    ...
    {
        $title = Lang::get("labels.ListingCountries");
        $countryData = array();
        $message = array();
        $errorMessage = array();
        ...
        return view("admin.countries.index", ["title"=>$title])->with('result', $result)->with('countryData', $countryData);
    }

    public function add(Request $request)
    {
        $title = Lang::get("labels.AddCountry");
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.countries.add", ["title"=>$title])->with('result', $result);
    }

    public function insert(Request $request)
    {
        $title = Lang::get("labels.EditCountry");
        $countryData = array();
    ...
    public function edit($id)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.countries.edit", ["title"=>$title])->with('result', $result)->with('country', $country);
    }
    ...
    public function filter(Request $request)
    {
        ...
        $countryData['countries'] = $countries;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.countries.index", ["title"=>$title])->with('result', $result)->with('countryData', $countryData)->with('name', $name)->with('param', $param);
    }

    public function listingZones(Request $request)
    {
        $title = Lang::get("labels.ListingZones");
        ...
        return view("admin.listingZones", ["title"=>$title])->with('result', $result);
    }

    //addcountry
    public function addZone(Request $request)
    {
        $title = Lang::get("labels.AddZone");
        ...
        return view("admin.addZone", ["title"=>$title])->with('result', $result);
    }
    ...
    {
        $title = Lang::get("labels.EditZone");
        $result = array();
        ...
        return view("admin.editZone", ["title"=>$title])->with('result', $result);
    }
    ...
    public function filterzones(Request $request)
    {
        ...
        return view("admin.listingZones", ["title"=>$title])->with('result', $result)->with('name', $name)->with('param', $param);
    ...
    {
        $title = Lang::get("labels.ListingTaxClasses");
        ...
        return view("admin.taxclass", ["title"=>$title])->with('result', $result);
    }

    //addtaxclass
    public function addtaxclass(Request $request)
    {
        $title = Lang::get("labels.AddTaxClass");
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.addtaxclass", ["title"=>$title])->with('result', $result);
    }
    ...
    public function edittaxclass(Request $request)
    {
        ...
        return view("admin.edittaxclass", ["title"=>$title])->with('result', $result);
    }
    ...
    public function taxclassfilter(Request $request)
    {
        ...
        return view("admin.taxclass", ["title"=>$title])->with('result', $result)->with('name', $name)->with('param', $param);
    ...
    {
        $title = Lang::get("labels.ListingTaxRates");
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.taxrates", ["title"=>$title])->with('result', $result);
    }
    ...
    public function addtaxrate(Request $request)
    {
        ...
        return view("admin.addtaxrate", ["title"=>$title])->with('result', $result);
    }
    ...
    {
        $title = Lang::get("labels.EditTaxRate");
        $result = array();
        $result['message'] = array();
        ...
        return view("admin.edittaxrate", ["title"=>$title])->with('result', $result);
    }
    ...
    public function taxratesfilters(Request $request)
    {
        ...
        return view("admin.taxrates", ["title"=>$title])->with('result', $result)->with('name', $name)->with('param', $param);
