...
class TaxController extends Controller
{
    ...
    public function taxindex(Request $request){
        ...
        return view("admin.tax.taxclass.index", ["title"=>$title])->with('result', $result)->with('tax_class', $tax_class);
    }

    public function addtaxclass(Request $request){
        $title = Lang::get("labels.AddTaxClass");
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.tax.taxclass.add", ["title"=>$title])->with('result', $result);
    }
    ...
    public function edittaxclass(Request $request){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.tax.taxclass.edit",["title"=>$title])->with('result', $result)->with('taxClass', $taxClass);
    }
    ...
    public function filtertaxclass(Request $request){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.tax.taxclass.index", ["title"=>$title])->with('result', $result)->with('tax_class', $tax_class)->with('name', $name)->with('param', $param);
    }
    ...
    public function displaytaxrates(Request $request){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.tax.taxrate.index", ["title"=>$title])->with('result', $result);
    }
    ...
    public function addtaxrate(Request $request){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.tax.taxrate.add", ["title"=>$title])->with('result', $result);
    }
    ...
    public function edittaxrate(Request $request){
        ...
        $result['tax_class'] = $tax_class;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.tax.taxrate.edit",["title"=>$title])->with('result', $result);
    }
    ...
    public function filtertaxrates(Request $request){
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.tax.taxrate.index", ["title"=>$title])->with('result', $result)->with('name', $name)->with('param', $param);
