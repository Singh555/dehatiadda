...
class OrdersController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        if (count($result['cart']) == 0) {
            ...
            $result['all_address'] = $all_addresses;
    ...
    public function checkout_shipping_address(Request $request)
    {
        ...
        $result = array();
        $result['commonContent'] = $this->index->commonContent();
        $address_id = $request->input('shipping_address');
        $shiping_address = $this->shipping->getShippingAddress($address_id);
        $billing_data = array();
        $shipping_data = array();
        foreach ($shiping_address as $value) {

            //billing address
            
                 $shipping_data['firstname'] = $value->firstname;
                $billing_data['billing_firstname'] = $value->firstname;
            
                $shipping_data['lastname'] = $value->lastname;
                $billing_data['billing_lastname'] = $value->lastname;
            
                $shipping_data['company'] = $value->company;
                $billing_data['billing_company'] = $value->company;
           
                $shipping_data['street'] = $value->street;
                $billing_data['billing_street'] = $value->street;
           
                $shipping_data['countries_id'] = $value->countries_id;
                $billing_data['billing_countries_id'] = $value->countries_id;
            
                $shipping_data['zone_id'] = $value->zone_id;
                $billing_data['billing_zone_id'] = $value->zone_id;
            
                $shipping_data['city'] = $value->city;
                $billing_data['billing_city'] = $value->city;
            
                $shipping_data['postcode'] = $value->postcode;
                $billing_data['billing_zip'] = $value->postcode;
           
                 $shipping_data['delivery_phone'] = auth()->guard('customer')->user()->phone;
                $billing_data['billing_phone'] = auth()->guard('customer')->user()->phone;
        }
    ...
    public function place_order(Request $request)
    {
        ...
        if ($payment_status) {
            if(is_array($payment_status) && count($payment_status) > 0){
                return redirect('/pay')->with('data', $payment_status);
            }else{
    ...
    public function shipping_methods()
    {
        ...
        foreach ($shippings as $shipping_methods) {
           ...
           if(isset($shippings_detail[0]->name)){
            //ups shipping rate
    ...
    public function getPaymentMethods()
    {
        ...
        /*
        $payments_setting = $this->order->payments_setting_for_brain_tree();
        if(isset($payments_setting['merchant_id']->environment)){
        if (isset($payments_setting['merchant_id']->environment)&&$payments_setting['merchant_id']->environment == '0') {
     ...
     /*
        ...
        if(isset($payments_setting['publishable_key']->environment)){
...
$wallet = array();
       ...
       /*
        ...
        if(isset($payments_setting['auth_token']->name)){
        ...
        */
        ...
        //dd($payments_setting);
        if(isset($payments_setting['userid']->name)){
    ...
    $razorpay = array();
        ...
        if(isset($payments_setting['RAZORPAY_SECRET']->environment)){
        ...
        */
        $paytm = array();
        /*
     if(isset($payments_setting['paytm_mid']->environment)){
        ...
        */
         $banktransfer = array();
    /*     
if(isset($payments_setting['account_name']->environment)){
        ...
        */
        $paystack = array();
        /*
        if(isset($payments_setting['secret_key']->environment)){
