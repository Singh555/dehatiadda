...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
      ...
      'Customer' => \App\Http\Middleware\RedirectIfNotCustomer::class,
        ...
        'view_shop' => \App\Http\Middleware\shops\view_shop::class,
        'edit_shop' => \App\Http\Middleware\shops\edit_shop::class,
        'delete_shop' => \App\Http\Middleware\shops\delete_shop::class,
        'add_shop' => \App\Http\Middleware\shops\add_shop::class,
