...
view()->share('web_setting', $settings);
        ...
        $homeBanners = DB::table('constant_banners')
            ...
            ->select('constant_banners.*', 'constant_banners.banners_image_url as path')
            ->where('languages_id', session('language_id'))
        ...
        $manufacturers = DB::table('manufacturers')
            ...
            ->select('manufacturers.*', 'manufacturers_info.*', 'manufacturer_image_url as manufacturer_image')
            ->get();
        ...
        $homepagebanners = DB::table('home_banners')
            ...
            ->select('home_banners.*', 'home_banners.image_url as image_path')
            ->where('language_id', Session::get('language_id'))
    ...
    private function allcategories()
    {
        $categories = DB::table('categories')
            ...
            ->select('categories.categories_id as id',
                ...
                'categories.categories_image_url as path'
            )
    ...
    public function cart($request)
    {
        ...
        $cart = DB::table('customers_basket')
            ...
            ->select('customers_basket.*', 'products.products_model as model', 'products.products_image_url as image', 'products.products_image_url as products_image',
        ...
        if (!isset(auth()->guard('customer')->user()->id)) {
            ...
            $cart->where('customers_basket.customers_id', '=', auth()->guard('customer')->user()->id);
        }
