    ...
    public function myCart($baskit_id)
    {
        $cart = DB::table('customers_basket')
            ...
            ->select('customers_basket.*',
                'products.products_image_url as image_path', 'products.products_model as model',
            ...
            foreach ($baskit as $cart_data) {
                ...
                if ($cart_data->products_type == '0') {
                    ...
                    if (!isset(auth()->guard('customer')->user()->id)) {
                        ...
                        $attributes->where('customers_basket_attributes.customers_id', '=', auth()->guard('customer')->user()->id);
                    }
