    ...
    public static function recursiveMenu()
    {
        ...
        if ($items->isNotEmpty()) {
            ...
            foreach ($menus as $parents) {
                ...
                if ($parents->status == 0) {
                    $status = '<span class="badge badge-warning">' . Lang::get("labels.InActive") . '</span>';
                } else {
                    $status = '<span class="badge badge-success">' . Lang::get("labels.Active") . '</span>';
                }
                ...
                <a href="editmenu/' . $parents->id . '" class="badge-info badge-pill edit-menu">
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                </a>
                <button id="deleteProductId" products_id="' . $parents->id . '" class="badge-danger badge-pill delete-menu">
