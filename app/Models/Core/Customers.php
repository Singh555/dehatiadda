...
class Customers extends Model
{
    ...
    public function getter(){
        ...
        $user = CustomerModel::sortable(['id'=>'ASC'])
...
$user = CustomerModel::sortable(['id'=>'ASC'])
    ...
    public function email($request){
        $existEmail = CustomerModel::where('email', '=', $request->email)->get();
        return $existEmail;
    }
    ...
    public function edit($id){
        CustomerModel::where('id', '=', $id)->update(['is_seen' => 1 ]);
    ...
    public function updaterecord($customer_data,$user_id,$user_data){
      ...
      CustomerModel::where('id', '=', $user_id)->update($customer_data);
    ...
    public function destroyrecord($user_id){
      CustomerModel::where('customers_id', '=', $user_id)->delete();
    ...
    public function Orders($customer_id){
        ...
        $orders = DB::table('orders')->orderBy('created_at', 'DESC')
            ->where('customers_id', '=', $customer_id)->paginate(20);
