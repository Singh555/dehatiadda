...
class Admin extends Model
{
    ...
    public function edit($id){
        $admin = $this->leftJoin('images','images.id', '=', 'admins.avatar')
            ->leftJoin('user_to_address','admins.id', '=', 'user_to_address.user_id')
            ->leftJoin('address_book','address_book.address_book_id', '=', 'user_to_address.address_book_id')
            ->select('admins.*', 'admins.avatar as image','address_book.*')
