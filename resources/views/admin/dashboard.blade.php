            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    <div class="inner">
                      <h3>@if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $result['purchase'] }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</h3>
                    ...
                    <div class="nav-tabs-custom">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <p class="notify-colors"><span class="sold-content" data-toggle="tooltip" data-placement="bottom" title="Sold Products"></span> Web Sold Products  <span class="purchased-content" data-toggle="tooltip" data-placement="bottom" title="Added Products"></span>App Sold Products </p>
                            </div>
                        </div>
                                            ...
                                            @foreach($total_orders as $key=>$orders)
                                                @if($key<=10)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ URL::to('admin/orders/vieworder/') }}/{{ $orders->orders_id }}" data-toggle="tooltip" data-placement="bottom" title="Go to detail">{{ $orders->order_id }} <i class="fa fa-eye"></i></a></td>
