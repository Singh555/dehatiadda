                            ...
                            <div class="row">
                                            ...
                                            @foreach($result['products_attributes'] as $key=>$products_attributes)
                                                @if($products_attributes->is_default == '1')
                                                    <tr>
                                                        ...
                                                        <td>{{ $products_attributes->sku }}</td>
                                                        <td>@if(!empty($products_attributes->image)) <img width="100px;" src="{{asset($products_attributes->image)}}">@endif</td>
                                    ...
                                    <div class="modal fade" id="adddefaultattributesmodal" tabindex="-1" role="dialog" aria-labelledby="addAttributeModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                {!! Form::hidden('products_id',  $result['data']['products_id'], array('class'=>'form-control', 'id'=>'add_default_products_id')) !!}
                                                {!! Form::hidden('subcategory_id',  $result['subcategory_id'], array('class'=>'form-control', 'id'=>'add_default_subcategory_id')) !!}
                                                {!! Form::hidden('is_default',  '1', array('class'=>'form-control', 'id'=>'add_default_is_default')) !!}
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            <select class="form-control default-option-id field-validate" name="products_options_id" id="add_default_products_options_id">
                            	...
                            	{{ trans('labels.AddOptionNameText') }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            <select class="form-control products_options_values_id field-validate" name="products_options_values_id" id="add_default_products_options_values_id">
                                                            </select>
                                  ...
                                  {{ trans('labels.AddOptionValueText') }}</span>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            ...
                                                            <input type="file" autocomplete="off" class="form-control" onchange="previewImage(this)" name="image_id" id="add_default_attribute_image_file" required="">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            ...
                                                            <input type="text" autocomplete="off" class="form-control"  name="sku" id="addDefaultSku">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="modal fade" id="addAttributeModal" tabindex="-1" role="dialog" aria-labelledby="addAttributeModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                {!! Form::hidden('products_id',  $result['data']['products_id'], array('class'=>'form-control', 'id'=>'add_attribute_products_id')) !!}

                                                {!! Form::hidden('subcategory_id',  $result['subcategory_id'], array('class'=>'form-control', 'id'=>'add_attribute_subcategory_id')) !!}
                                                {!! Form::hidden('is_default',  '0', array('class'=>'form-control', 'id'=>'add_attribute_is_default')) !!}
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.OptionName') }}  </label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <select class="form-control  additional-option-id field-validate" name="products_options_id" id="add_attribute_products_options_id">										 									  <option value="" class="field-validate">{{ trans('labels.ChooseOptions') }}</option>
                                                                @foreach($result['options'] as $option)
                                                                    <option value="{{ $option->products_options_id }}">{{ $option->options_name }}</option>
                                                                @endforeach
                                                            </select>  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
								  {{ trans('labels.OptionNameText') }}
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.OptionValues') }}</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <select class="form-control additional_products_options_values_id field-validate" name="products_options_values_id" id="add_attribute_products_options_values_id">
                                                            </select>
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                  {{ trans('labels.OptionValuesText') }}</span>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-4 col-sm-2">
                                                            <select class="form-control" name="price_prefix" id="add_attribute_price_prefix">
                                                                <option value="+">+</option>
                                                                <option value="-">-</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-xs-8 col-sm-8 col-md-6">
                                                            {!! Form::text('options_values_price',  '0', array('class'=>'form-control', 'id'=>'add_attribute_options_values_price')) !!}
                                                ...
                                                <div class="col-sm-10 col-md-8">
                                                    ...
                                                    <input type="file" autocomplete="off" class="form-control"  onchange="previewImage(this)" name="image_id" id="add_attribute_image_file" required="">
                                                ...
                                                <div class="col-sm-10 col-md-4 hidden previewImage">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            ...
                                                            <input type="text" autocomplete="off" class="form-control" name="sku" id="addAttributeSku">
