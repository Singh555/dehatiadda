                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('sku', $result['product'][0]->sku, array('class'=>'form-control', 'id'=>'sku')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::hidden('oldImage', $result['product'][0]->products_image_url , array('id'=>'oldImage', 'class'=>'field-validate ')) !!}
                                                        <img src="{{asset($result['product'][0]->products_image_url)}}" alt="" width=" 100px">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <select name="is_cod" class="form-control">
                                                            <option value="Y" @if($result['product'][0]->is_cod == 'Y')selected=''@endif>Yes</option>
                                                            <option value="N" @if($result['product'][0]->is_cod == 'N')selected=''@endif>No</option>
                                                        </select>
