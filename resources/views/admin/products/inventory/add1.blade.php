                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10 col-md-8 ">
                                                                        ...
                                                                        <select class="form-control field-validate product-type select2" name="products_id">
                                                                            <option value="">{{ trans('labels.Choose Product') }}</option>
                                                                            @foreach ($result['products'] as $pro)
                                                                            <option value="{{$pro->products_id}}" >{{$pro->products_name}}/{{$pro->products_model}}</option>
                                                                            @endforeach
