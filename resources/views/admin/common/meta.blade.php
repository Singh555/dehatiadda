...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css">
  ...
  <link href="{!! asset('admin/dist/css/skins/_all-skins.min.css') !!} " media="all" rel="stylesheet" type="text/css" />
    ...
    <link href="https://cdn.datatables.net/buttons/1.7.0/css/buttons.dataTables.min.css " media="all" rel="stylesheet" type="text/css" />
  ...
  <link href="{{asset('admin/plugins/datatables/datatables.min.css')}}" media="all" rel="stylesheet" type="text/css" />
