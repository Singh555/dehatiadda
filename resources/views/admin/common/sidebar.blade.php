<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      ?>
      <li class="treeview {{ Request::is('admin/medias') ? 'active' : '' }}">
        <a href="#">
...
{{--
     ...
     {{-- <li class="treeview {{ Request::is('admin/currencies/display') ? 'active' : '' }} {{ Request::is('admin/currencies/add') ? 'active' : '' }} {{ Request::is('admin/currencies/edit/*') ? 'active' : '' }} {{ Request::is('admin/currencies/filter') ? 'active' : '' }}">
      ...
      ?>
        <li class="treeview {{ Request::is('admin/customers/display') ? 'active' : '' }} {{ Request::is('admin/customers/teamList') ? 'active' : '' }} {{ Request::is('admin/customers/nonPrimeReferral') ? 'active' : '' }} {{ Request::is('admin/customers/primeReferral') ? 'active' : '' }} {{ Request::is('admin/customers/kyc') ? 'active' : '' }} {{ Request::is('admin/customers/mwalletview') ? 'active' : '' }} {{ Request::is('admin/customers/swalletview') ? 'active' : '' }} {{ Request::is('admin/customers/view') ? 'active' : '' }} {{ Request::is('admin/customers/nonprime') ? 'active' : '' }} {{ Request::is('admin/customers/withdrawal') ? 'active' : '' }} {{ Request::is('admin/customers/prime') ? 'active' : '' }} {{ Request::is('admin/customers/add') ? 'active' : '' }}  {{ Request::is('admin/customers/edit/*') ? 'active' : '' }} {{ Request::is('admin/customers/address/display/*') ? 'active' : '' }} {{ Request::is('admin/customers/filter') ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.link_customers') }}</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
        <ul class="treeview-menu">
            <li class="{{ Request::is('admin/customers/display') ? 'active' : '' }}">
                      <a class="nav-link" href="{{ URL::to('admin/customers/display')}}">
                          <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.viewAllCustomers') }}</span>
                      </a>
                  </li>
        <li class=" {{ Request::is('admin/customers/view') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/view')}}">
                          <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.Customer') }}</span>
                      </a>
                  </li>
              
              <li class=" {{ Request::is('admin/customers/prime') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/prime')}}">
                          <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.viewPrimeCustomers') }}</span>
                      </a>
                  </li>
              <li class=" {{ Request::is('admin/customers/nonprime') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/nonprime')}}">
                          <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.viewNonPrimeCustomers') }}</span>
                      </a>
                  </li>
              <li class=" {{ Request::is('admin/customers/withdrawal') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/withdrawal')}}">
                          <i class="fa fa-hourglass-start" aria-hidden="true"></i> <span>{{ trans('labels.viewWithdrawals') }}</span>
                      </a>
                  </li>
              <li class=" {{ Request::is('admin/customers/kyc') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/kyc')}}">
                          <i class="fa fa-user-check" aria-hidden="true"></i> <span>{{ trans('labels.viewKyc') }}</span>
                      </a>
                  </li>
              <li class=" {{ Request::is('admin/customers/primeReferral') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/primeReferral')}}">
                          <i class="fa fa-user-shield" aria-hidden="true"></i> <span>{{ trans('labels.viewPrimeReferral') }}</span>
                      </a>
                  </li>
              <li class=" {{ Request::is('admin/customers/nonPrimeReferral') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/nonPrimeReferral')}}">
                          <i class="fa fa-user" aria-hidden="true"></i> <span>{{ trans('labels.viewNonPrimeReferral') }}</span>
                      </a>
                  </li>
              <li class=" {{ Request::is('admin/customers/teamList') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/teamList')}}">
                          <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.teamListView') }}</span>
                      </a>
                  </li>
                  <li class=" {{ Request::is('admin/customers/mwalletview') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/mwalletview')}}">
                          <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.ViewMwalletTxn') }}</span>
                      </a>
                  </li>
                  <li class=" {{ Request::is('admin/customers/swalletview') ? 'active' : '' }}">
                      <a class="" href="{{ URL::to('admin/customers/swalletview')}}">
                          <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.ViewSwalletTxn') }}</span>
                      </a>
                  </li>
                  </ul>
        </li>
          ...
          <ul class="treeview-menu">
            ...
            @if ($result['commonContent']['roles']!= null and $result['commonContent']['roles']->products_view == 1)
              ...
              <li class="{{ Request::is('admin/products/inventory/display') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/inventory/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.inventory') }}</a></li>
               <li class="{{ Request::is('admin/products/inventory/add_bulk') ? 'active' : '' }}"><a href="{{ URL::to('admin/products/inventory/add_bulk')}}"><i class="fa fa-circle-o"></i> Bulk Inventory</a></li>
            @endif
            <?php
      ...
      ?>
        <li class="treeview {{ Request::is('admin/orderstatus') ? 'active' : '' }} {{ Request::is('admin/addorderstatus') ? 'active' : '' }} {{ Request::is('admin/editorderstatus/*') ? 'active' : '' }} {{ Request::is('admin/orders/*') ? 'active' : '' }} {{ Request::is('admin/orders/vieworder/*') ? 'active' : '' }}">
          ...
          <li class="{{ Request::is('admin/orderstatus') ? 'active' : '' }} {{ Request::is('admin/addorderstatus') ? 'active' : '' }} {{ Request::is('admin/editorderstatus/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/orderstatus')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_order_status') }}</a></li>
            ...
            <li class="{{ Request::is('admin/orders/new') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/new')}}" >
                <i class="fa fa-circle-o" aria-hidden="true"></i> <span> New Orders</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/orders/cancelled') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/cancelled')}}" >
                <i class="fa fa-circle-o text-danger" aria-hidden="true"></i> <span> Cancelled Orders</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/orders/pending') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/pending')}}" >
                <i class="fa fa-circle-o text-warning" aria-hidden="true"></i> <span> Pending Orders</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/orders/processing') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/processing')}}" >
                <i class="fa fa-hourglass-start" aria-hidden="true"></i> <span> Processing Orders</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/orders/shipped') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/shipped')}}" >
                <i class="fa fa-circle-o" aria-hidden="true"></i> <span> Shipped Orders</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/orders/complete') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/complete')}}" >
                <i class="fa fa-check-square text-success" aria-hidden="true"></i> <span> Completed Orders</span>
              </a>
            </li>
            <li class="{{ Request::is('admin/orders/failed') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/failed')}}" >
                <i class="fa fa-ban text-danger" aria-hidden="true"></i> <span> Failed Orders</span>
              </a>
            </li>
          </ul>
        </li>
  ...
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
      ...
      <?php
        ...
        <li class="treeview {{ Request::is('admin/shop*') ? 'active' : '' }} ">
          <a href="#">
            <i class="fa fa-shopping-bag" aria-hidden="true"></i> <span>{{ trans('labels.manage Shops') }}</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
            <ul class="treeview-menu">
                <li class="treeview {{ Request::is('admin/shop') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/shop')}}" ><i class="fa fa-circle" aria-hidden="true"></i> <span>All Shops</span></a>
                </li>
                <li class="treeview {{ Request::is('admin/shop/new') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/shop/new')}}" ><i class="fa fa-circle text-warning" aria-hidden="true"></i> <span>New Shops</span></a>
                </li>
                <li class="treeview {{ Request::is('admin/shop/rejected') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/shop/rejected')}}" ><i class="fa fa-circle text-danger" aria-hidden="true"></i> <span>Rejected Shops</span></a>
                </li>
                <li class="treeview {{ Request::is('admin/shop/approved') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/shop/approved')}}" ><i class="fa fa-circle text-success" aria-hidden="true"></i> <span>Approved Shops</span></a>
                </li>
            </ul>
        </li>
        <li class="treeview {{ Request::is('admin/vendor*') ? 'active' : '' }} ">
          <a href="#">
            <i class="fa fa-ship" aria-hidden="true"></i> <span>All Vendors</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
            <ul class="treeview-menu">
                <li class="treeview {{ Request::is('admin/vendor') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/vendor')}}" ><i class="fa fa-circle" aria-hidden="true"></i> <span>All Vendors</span></a>
                </li>
                <li class="treeview {{ Request::is('admin/vendor/new') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/vendor/new')}}" ><i class="fa fa-circle text-warning" aria-hidden="true"></i> <span>New Vendors</span></a>
                </li>
                <li class="treeview {{ Request::is('admin/vendor/rejected') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/vendor/rejected')}}" ><i class="fa fa-circle text-danger" aria-hidden="true"></i> <span>Rejected Vendors</span></a>
                </li>
                <li class="treeview {{ Request::is('admin/vendor/approved') ? 'active' : '' }}">
                  <a href="{{ URL::to('admin/vendor/approved')}}" ><i class="fa fa-circle text-success" aria-hidden="true"></i> <span>Active Vendors</span></a>
                </li>
            </ul>
        </li>
      <?php } ?>
...
{{--           
<li class="nav-item {{ Request::is('admin/homeSections') ? 'active' : '' }} {{ Request::is('admin/homeSections/*') ? 'active' : '' }}"><a class="nav-link" href="{{ URL::to('admin/homeSections')}}"><i class="nav-icon fa fa-circle"></i> {{ trans('labels.link_HomeSections') }}</a></li>
--}}
<li class="treeview {{ Request::is('admin/homeSections/*') ? 'active' : '' }}">
			<a class="nav-link" href="#">
			<i class="nav-icon fa fa-mobile fa-2x"></i> {{ trans('labels.link_HomeSections') }}
			<i class="fa fa-angle-left pull-right"></i>
			</a>
			<ul class="treeview-menu">
                          <li class="{{ Request::is('admin/homeSections/fourBox') ? 'active' : '' }} {{ Request::is('admin/homeSections/fourBox/*') ? 'active' : '' }}">
                              <a href="{{ URL::to('admin/homeSections/fourBox')}}"><i class="fa fa-circle-o"></i> FourBox</a>
                          </li>
                          <li class="{{ Request::is('admin/homeSections/twoBox') ? 'active' : '' }} {{ Request::is('admin/homeSections/twoBox/*') ? 'active' : '' }}">
                              <a href="{{ URL::to('admin/homeSections/twoBox')}}"><i class="fa fa-circle-o"></i> TwoBox</a>
                          </li>
                          <li class="{{ Request::is('admin/homeSections/bannerPlainLarge') ? 'active' : '' }} {{ Request::is('admin/homeSections/bannerPlainLarge/*') ? 'active' : '' }}">
                              <a href="{{ URL::to('admin/homeSections/bannerPlainLarge')}}"><i class="fa fa-circle-o"></i> Banner Plain Large</a>
                          </li>
                          <li class="{{ Request::is('admin/homeSections/bannerPlainThin') ? 'active' : '' }} {{ Request::is('admin/homeSections/bannerPlainThin/*') ? 'active' : '' }}">
                              <a href="{{ URL::to('admin/homeSections/bannerPlainThin')}}"><i class="fa fa-circle-o"></i> Banner Plain Thin</a>
                          </li>
                          <li class="{{ Request::is('admin/homeSections/verticleSliderWithBg') ? 'active' : '' }} {{ Request::is('admin/homeSections/verticleSliderWithBg/*') ? 'active' : '' }}">
                              <a href="{{ URL::to('admin/homeSections/verticleSliderWithBg')}}"><i class="fa fa-circle-o"></i> Verticle Slider With Bg</a>
                          </li>
                          <li class="{{ Request::is('admin/homeSections/videoCarasoul') ? 'active' : '' }} {{ Request::is('admin/homeSections/videoCarasoul/*') ? 'active' : '' }}">
                              <a href="{{ URL::to('admin/homeSections/videoCarasoul')}}"><i class="fa fa-circle-o"></i> Video Carasoul</a>
                          </li>
                          <li class="{{ Request::is('admin/homeSections/productMarqee') ? 'active' : '' }} {{ Request::is('admin/homeSections/productMarqee/*') ? 'active' : '' }}">
                              <a href="{{ URL::to('admin/homeSections/productMarqee')}}"><i class="fa fa-circle-o"></i> Product Marqee</a>
                          </li>
                        </ul>
            ...
            <li class="{{ Request::is('admin/pages') ? 'active' : '' }}  {{ Request::is('admin/addpage') ? 'active' : '' }}  {{ Request::is('admin/editpage/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/pages')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.content_pages') }}</a></li>
             ...
             {{-- <li class="treeview {{ Request::is('admin/admobSettings') ? 'active' : '' }}"><a class="" href="{{ URL::to('admin/admobSettings')}}"><i class="nav-icon fa fa-circle"></i> {{ trans('labels.link_admob') }}</a></li>
             --}}
            <li class="treeview {{ Request::is('admin/videolinks') ? 'active' : '' }}"><a class="" href="{{ URL::to('admin/videolinks')}}"><i class="nav-icon fa fa-circle"></i> {{ trans('labels.videolinks') }}</a></li>
  ...
  <span> {{ trans('labels.Backup / Restore') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview">
                    <a data-toggle="collapse" href="#" class="">
                      ...
                      <p>
                        Power <i class="fa fa-angle-left pull-right"></i>
                      </p>
                    </a>
                    <ul class="treeview-menu">
                      <li class="">
                         <a class="" href="#" onclick="event.preventDefault(); document.getElementById('shut-down').submit();" role="button">
                          <i class="fa fa-power-off text-danger"></i>
                          <p>Log Out</p>
                         </a>
                         <form id="shut-down" action="" method="POST" style="display: none;">
                           @csrf
                         </form>
                      </li>
                    </ul>
