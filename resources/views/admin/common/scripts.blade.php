...
$(function() {
     $("#example1").DataTable({
        ...
        buttons: [
                    ...
                    { extend: 'copy',"charset": "utf-8", text: "{{__('copy')}}",exportOptions: {columns: ':not(.notexport)' }},
                    { extend: 'excel',"charset": "utf-8", text: "{{__('excel')}}",exportOptions: {columns: ':not(.notexport)' }},
                    { extend: 'csv',"charset": "utf-8", text: "{{__('csv')}}",exportOptions: {columns: ':not(.notexport)' }},
                    { extend: 'pdf',"charset": "utf-8", text: "{{__('pdf')}}",exportOptions: {columns: ':not(.notexport)' }},
                    { extend: 'print',"charset": "utf-8", text: "{{__('print')}}",exportOptions: {columns: ':not(.notexport)'}}
    ...
    $(".example1").DataTable({
        ...
        language: {
          search: '<i class="text-primary fa fa-search"></i>',
...
$(document).on('click', '#addAttribute', function(e){
	...
	//var formData = $('#addattributefrom').serialize();
       ...
       var file_data = $("#add_attribute_image_file").prop("files")[0];
    form_data.append('image_id', file_data);
    form_data.append('is_default', $('#add_attribute_is_default').val());
    form_data.append('products_id', $('#add_attribute_products_id').val());
    form_data.append('subcategory_id', $('#add_attribute_subcategory_id').val());
    form_data.append('products_options_id', $('#add_attribute_products_options_id').val());
    form_data.append('price_prefix', $('#add_attribute_price_prefix').val());
    form_data.append('options_values_price', $('#add_attribute_options_values_price').val());
    form_data.append('products_options_values_id', $('#add_attribute_products_options_values_id').val());
    form_data.append('sku', $('#addAttributeSku').val());
			...
			if(res.length != ''){
				...
				for (i = 0; i < res.length; ++i) {
					...
					//showData[i] = "<tr><td>"+j+"</td><td>"+res[i].products_options_name+"</td><td>"+res[i].products_options_values_name+"</td><td>"+res[i].price_prefix+" "+res[i].options_values_price+"</td><td>    <a class='badge bg-light-blue editproductattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"'  language_id = '"+res[i].language_id+"' options_id= '"+res[i].options_id+"'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></a> <a class='badge bg-red deleteproductattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"' ><i class='fa fa-trash' aria-hidden='true'></i></a></td></tr>";
                                        showData[i] = "<tr><td>"+j+"</td><td>"+res[i].products_options_name+"</td><td>"+res[i].products_options_values_name+"</td><td>"+res[i].price_prefix+" "+res[i].options_values_price+"</td><td>"+res[i].sku+"</td><td><img width='100px;' src='{{env('APP_URL')}}/"+res[i].image+"'></td><td>    <a class='badge bg-light-blue editproductattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"'  language_id = '"+res[i].language_id+"'  options_id = '"+res[i].options_id+"'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></a> <a class='badge bg-red deleteproductattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"' language_id = '"+res[i].language_id+"'  options_id = '"+res[i].options_id+"'><i class='fa fa-trash' aria-hidden='true'></i></a></td></tr>";
...
$(document).on('click', '#addDefaultAttribute', function(e){
	$("#loader").show();
	//var formData = $('#adddefaultattributefrom').submit();
       var form_data = new FormData();
                 var file_data = $("#add_default_attribute_image_file").prop("files")[0];
        form_data.append('image_id', file_data);
    form_data.append('is_default', $('#add_default_is_default').val());
    form_data.append('products_attributes_id', $('#add_default_products_attributes_id').val());
    form_data.append('products_id', $('#add_default_products_id').val());
    form_data.append('subcategory_id', $('#add_default_subcategory_id').val());
    form_data.append('products_options_id', $('#add_default_products_options_id').val());
    form_data.append('products_options_values_id', $('#add_default_products_options_values_id').val());
    form_data.append('sku', $('#addDefaultSku').val());
    form_data.append('_token', "{{ csrf_token() }}");
	$.ajax({
			...
			if(res.length != ''){
				...
				for (i = 0; i < res.length; ++i) {
					...
					//showData[i] = "<tr><td>"+j+"</td><td>"+res[i].products_options_name+"</td><td>"+res[i].products_options_values_name+"</td><td><a class='badge bg-light-blue editdefaultattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"' language_id ='"+res[i].language_id+"' options_id ='"+res[i].options_id+"'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></a> <a class='badge bg-red deletedefaultattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"' ><i class='fa fa-trash' aria-hidden='true'></i></a></td></tr>";
				        showData[i] = "<tr><td>"+j+"</td><td>"+res[i].products_options_name+"</td><td>"+res[i].products_options_values_name+"</td><td>"+res[i].sku+"</td><td><img width='100px;' src='{{env('APP_URL')}}/"+res[i].image+"'></td><td><a class='badge bg-light-blue editdefaultattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"' language_id ='"+res[i].language_id+"' options_id ='"+res[i].options_id+"'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></a> <a class='badge bg-red deletedefaultattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"' ><i class='fa fa-trash' aria-hidden='true'></i></a></td></tr>";
...
$(document).on('click', '#updateAddress', function(e){
    ...
    var form_data = new FormData();
       var file_data = $("#edit_attribute_image_file").prop("files")[0];
    form_data.append('image_id', file_data);
    form_data.append('products_id', $('#edit_attribute_products_id').val());
    form_data.append('products_attributes_id', $('#edit_products_attributes_id').val());
    form_data.append('products_options_id', $('#edit_attribute_products_options_id').val());
    form_data.append('price_prefix', $('#edit_attribute_price_prefix').val());
    form_data.append('options_values_price', $('#edit_attribute_options_values_price').val());
    form_data.append('products_options_values_id', $('#edit_attribute_products_options_values_id').val());
    form_data.append('sku', $('#editAttributeSku').val());
    form_data.append('_token', "{{ csrf_token() }}");
		$.ajax({
	...
	$(document).on('click', '#updateDefaultAttribute', function(e){
		...
		var form_data = new FormData();
                 var file_data = $("#edit_default_attribute_image_file").prop("files")[0];
        form_data.append('image_id', file_data);
    form_data.append('products_attributes_id', $('#edit_default_products_attributes_id').val());
    form_data.append('products_id', $('#edit_default_products_id').val());
    form_data.append('products_options_id', $('#edit_default_products_options_id').val());
    form_data.append('products_options_values_id', $('#edit_default_products_options_values_id').val());
    form_data.append('sku', $('#editDefaultSku').val());
    form_data.append('_token', "{{ csrf_token() }}");
		$.ajax({
...
{{--{{ URL::to('admin/deleteproductattributemodal')}}--}}
	...
	$(document).on('click', '#deleteProductAttribute', function(){
		...
		console.log(formData);
		$.ajax({
			url: "{{ URL::to('admin/products/attach/attribute/default/options/delete')}}",
			type: "POST",
			data: formData,
			success: function (res) {
				$("#loader").hide();
