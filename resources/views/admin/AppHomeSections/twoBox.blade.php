                        ...
                        <div class="box-body">
                                ...
                                @if(!empty($result['editSectionData']->id))
                                      <div class="col-xs-12 col-md-12 ">
                                        <legend>
                                            Edit two Box Section Data
                                        </legend>
                                    </div>
                                
                                {!! Form::open(array('url' =>'admin/homeSections/twoBox/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                @else
                                    @if(count($result['sectionData'])<2)
                                    <div class="col-xs-12 col-md-12 ">
                                        <legend>
                                            Add two Box Section Data
                                        </legend>
                                    </div>

                                            {!! Form::open(array('url' =>'admin/homeSections/twoBox/insert', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            @php($i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $banners->urls }}</td>
                                                     ...
                                                     <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{url('admin/homeSections/twoBox/edit')}}/{{ $banners->id }}" class="text-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;
