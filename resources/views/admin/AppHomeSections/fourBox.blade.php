...
<div class="row">
        ...
        <div class="box box-info">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Four Box</h3>
                        </div>
                        ...
                        <div class="box-body">
                                ...
                                {!! Form::open(array('url' =>'admin/homeSections/fourBox/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                           ...
                                           <div class="col-xs-12 col-md-6 ">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-8">
                                                    <select class="form-control select2" style="width: 100%;" name="data_type" id="Section_data_type" required=''>
                                ...
                                @else
                                    ...
                                    <div class="col-xs-12 col-md-12 ">
                                        <legend>
                                            ...
                                            {!! Form::open(array('url' =>'admin/homeSections/fourBox/insert', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                           ...
                                           <div class="col-xs-12 col-md-6 ">
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Type') }}</label>
                                                <div class="col-sm-10 col-md-8">
                                                    <select class="form-control select2" style="width: 100%;" name="data_type" onchange="urlDataTypes(this);" required="">
                                                        <option value="">Select data Type</option>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                                    ...
                                    <!-- form start -->
                                    <form action="{{url('admin/homeSections/fourBox')}}" method="get" enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-xs-12 col-md-6 ">
                                        <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Choose Position </label>
                                                <div class="col-sm-10 col-md-8">
                                                    <select name="position" class="form-control select2" onchange="this.form.submit();" style="width: 100%;">
                                            ...
                                            @php($i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $banners->urls }}</td>
                                                     ...
                                                     <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{url('admin/homeSections/fourBox/edit')}}/{{ $banners->id }}" class="text-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;
