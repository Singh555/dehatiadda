...
<div class="row">
        ...
        <div class="box">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Banner Plain Large</h3>
                        </div>
                        ...
                        <div class="box-body">
                                ...
                                @if(!empty($result['editSectionData']->id))
                                      <div class="col-xs-12 col-md-12 ">
                                        <legend>
                                            Edit Banner Plain Large Section Data
                                        </legend>
                                    </div>
                                
                                {!! Form::open(array('url' =>'admin/homeSections/bannerPlainLarge/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                @else
                                    ...
                                    <div class="col-xs-12 col-md-12 ">
                                        <legend>
                                            Add Banner Pain Large Section Data
                                        </legend>
                                    </div>

                                            {!! Form::open(array('url' =>'admin/homeSections/bannerPlainLarge/insert', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            @php($i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $banners->urls }}</td>
                                                     ...
                                                     <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{url('admin/homeSections/bannerPlainLarge/edit')}}/{{ $banners->id }}" class="text-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;
