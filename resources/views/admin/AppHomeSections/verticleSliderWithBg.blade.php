...
<div class="row">
                <div class="col-md-12">
                                        ...
                                        <div class="col-xs-12 col-md-6 ">
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="hidden" name="oldImage" value="{{$result['section']->image}}">
                                                        <img src="{{asset($result['section']->image)}}" alt="" width=" 100px">
                                                    </div>
                                                </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Verticle Slider With Background</h3>
                        </div>
                        ...
                        <div class="box-body">
                                ...
                                @if(!empty($result['editSectionData']->id))
                                      <div class="col-xs-12 col-md-12 ">
                                        <legend>
                                            Edit verticle Slider With Background Section Data
                                        </legend>
                                    </div>
                                
                                {!! Form::open(array('url' =>'admin/homeSections/verticleSliderWithBg/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                @else
                                    @if(count($result['sectionData'])<10)
                                    <div class="col-xs-12 col-md-12 ">
                                        <legend>
                                            Add verticle Slider With Background Section Data
                                        </legend>
                                    </div>

                                            {!! Form::open(array('url' =>'admin/homeSections/verticleSliderWithBg/insert', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            @php($i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $banners->urls }}</td>
                                                     ...
                                                     <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{url('admin/homeSections/verticleSliderWithBg/edit')}}/{{ $banners->id }}" class="text-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;
