                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th class="notexport">{{ trans('labels.Icon') }}</th>
                                            <th >{{ trans('labels.apphome') }}</th>
                                        ...
                                        @endphp
                                           ...
                                           <td>{{ $count }}</td>
                                                        <td>
                                                            ...
                                                            @endif
                                                            {{ $category->name }}</td>
                                                        <td><img src="{{asset($category->categories_image_url)}}" alt="" width=" 100px"></td>
                                                        <td><img src="{{asset($category->categories_icon_url)}}" alt="" width=" 100px"></td>
                                                        <td>{{$category->app_home}}</td>
                                                        <td>
