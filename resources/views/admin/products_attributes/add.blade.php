                                        ...
                                        <div class="box-body">
                                            ...
                                            @foreach($result['languages'] as $languages)
                                                <div class="form-group">
                                                    <label for="name" class="col-md-3 control-label">{{ trans('labels.Name') }} ({{ $languages->name }})</label>
                                                    <div class="col-md-8">
                                            ...
                                            @endforeach
                                         <div class="form-group">
                                                    <label for="name" class="col-md-3 control-label">{{ trans('labels.Type') }} </label>
                                                    <div class="col-md-8">
                                                        <select class="form-control select2" style="width: 100%;" required="" name="swatch_type">
                                                            <option value="">Select</option>
                                                            <option value="color">Color Swatch</option>
                                                            <option value="text">Text Swatch</option>
                                                        </select>
                                                        <span class="help-block hidden">{{ trans('labels.Swatch Type Text') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        <!-- /.box-body -->
