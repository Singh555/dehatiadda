                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info"><br>
                                        ...
                                        <div class="box-body">
                                            ...
                                            @if($result['options']->swatch_type=='color')
                                     <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Option Value') }} ({{ $description_data['language_name'] }})</label>
                                            <div class="col-sm-10 col-md-4">
                                                <input type="color" name="options_values_<?=$description_data['languages_id']?>" class="form-control field-validate" value="{{$description_data['values']}}">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.Option Value Text') }} ({{ $description_data['language_name'] }}).</span>
                                                <span class="help-block hidden">{{ trans('labels.Option Value Text') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Option Value') }} ({{ $description_data['language_name'] }})</label>
                                            <div class="col-sm-10 col-md-4">
                                                <input type="text" name="options_values_<?=$description_data['languages_id']?>" class="form-control field-validate" value="{{$description_data['values']}}">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.Option Value Text') }} ({{ $description_data['language_name'] }}).</span>
                                                <span class="help-block hidden">{{ trans('labels.Option Value Text') }}</span>
                                            </div>
                                        </div>
