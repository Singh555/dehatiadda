                                ...
                                <div class="col-md-6">
                                    ...
                                    @foreach($result['languages'] as $languages)
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Option Value Name') }} ({{ $languages->name }})</label>
                                            <div class="col-sm-10 col-md-8">
                                                ...
                                                <span class="help-block hidden">{{ trans('labels.Option Value Name Text') }}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                    @if($option->swatch_type=='color')
                                     <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Option Value') }} ({{ $languages->name }})</label>
                                            <div class="col-sm-10 col-md-8">
                                                <input type="color" name="Values_<?=$languages->languages_id?>" class="form-control field-validate">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.Option Value Text') }} ({{ $languages->name }}).</span>
                                    ...
                                    <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Option Value') }} ({{ $languages->name }})</label>
                                            <div class="col-sm-10 col-md-8">
                                                <input type="text" name="Values_<?=$languages->languages_id?>" class="form-control field-validate">
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.Option Value Text') }} ({{ $languages->name }}).</span>
                                                <span class="help-block hidden">{{ trans('labels.Option Value Text') }}</span>
                                            </div>
                                        </div>
                                                            ...
                                                            <p>
                                                                ...
                                                                @if(count($language->values)>0)
                                                                    @foreach($language->values as $value)
                                                                       Name: {{$value->options_values_name}}<br>
                                                                       Value: @if($option->swatch_type=='color') <i class="btn btn-sm" style="background-color: {{$value->options_values}};">&nbsp;&nbsp;&nbsp;</i> @else {{$value->options_values}} @endif<br>
                                                                    @endforeach
                                                                @else
                                                                    --- <br>
                                                                @endif
