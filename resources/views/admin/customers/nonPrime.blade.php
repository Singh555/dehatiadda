...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.Customers') }} <small>{{ trans('labels.ListingNonPrimeCustomers') }}...</small> </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                         <h3 class="box-title">{{ trans('labels.ListingNonPrimeCustomers') }}</h3>
                         {{--   <div class="row">
                                <div class="col-lg-6 form-inline" id="contact-form">
                                    <form name='registration' id="registration" class="registration" method="get" action="{{url('admin/customers/filter')}}">
                                        ...
                                        <div class="input-group-form search-panel ">
                                            ...
                                            <button class="btn btn-primary btn-sm " id="submit" type="submit"><span class="fa fa-search"></span></button>
