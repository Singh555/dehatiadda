    ...
    <div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                                    ...
                                    @endif
                                        ...
                                        {!! Form::open(array('url' =>'admin/customers/mwalletview', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                                                        <div class="form-group col-md-12">
                                                                        <label> Enter Customer Name/Email/Referral Code</label>
                                                                        <input type="text" required='' name="user_id" class="form-control" id="search-box" @if(!empty($phone)) value="{{$phone}}" @endif autocomplete="off">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header">
                <h4 class="box-title text-center">Main Wallet Transactions</h4>
            </div>
            <div class="box-body">
            <div class="col-xs-12 table-responsive">
                                <table class="table table-bordered table-striped example1">
                                    ...
                                    <tbody>
                                        @if (!empty($customers['mwallet']) && count($customers['mwallet'])>0)
                                        @foreach ($customers['mwallet'] as $listingCustomers)
                                        <tr>
