                                        ...
                                        @if(count($listingOrders['orders'])>0)
                                            @foreach ($listingOrders['orders'] as $key=>$orderData)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title="View Order" href="{{url('admin/orders/vieworder')}}/{{ $orderData->orders_id }}" class=""><i class="text-info fa fa-eye" aria-hidden="true"></i> View</a>
