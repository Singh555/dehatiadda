    ...
    <div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                                    ...
                                    @endif
                                        ...
                                        {!! Form::open(array('url' =>'admin/customers/primeReferral', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
        ...
        <div class="col-md-12">
            ...
            <div class="box-header">
                <h4 class="box-title text-center">{{ trans('labels.PrimeReferral') }}</h4>
            </div>
            <div class="box-body">
