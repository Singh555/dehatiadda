...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Orders') }} <small>Cancelled Orders...</small> </h1>
            <ol class="breadcrumb">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    @endif
                                     ...
                                     <div class="col-lg-6 form-inline col-lg-offset-8">
                                         ...
                                         <form  name='registration' class="registration" method="get" action="{{url('admin/orders/cancelled')}}">
                                      @csrf
                                    ...
                                    <div class="input-group-form search-panel ">
                                     ...
                                     @if(!empty(request()->get('query')))  <a class="btn btn-danger " href="{{url('admin/orders/cancelled')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                    </div>
                                </form>
                                </div>
                                </div>
