...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> {{ trans('labels.Orders') }} <small>Shipped Orders...</small> </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-lg-6 form-inline col-lg-offset-8">
                                         ...
                                         <form  name='registration' class="registration" method="get" action="{{url('admin/orders/shipped')}}">
                                      @csrf
                                    ...
                                    <div class="input-group-form search-panel ">
                                     ...
                                     @if(!empty(request()->get('query')))  <a class="btn btn-danger " href="{{url('admin/orders/shipped')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                    </div>
                                </form>
                                </div>
                                </div>
