            ...
            <div class="container">
             ...
             <form enctype="multipart/form-data" name="filters" id="test" method="get">
               ...
               <div class="range-slider-main" >
                   <h2><a href="#priceRangeCollapse" data-toggle='collapse' role='button' aria-expanded='false'>@lang('website.Price Range')</a> </h2>
                 <div class="sub-manu collapse multi-collapse" id="priceRangeCollapse">
                 <div class="wrapper">
               ...
               @include('web.common.scripts.slider')
                     ...
                     <div class="color-range-main">
                         <h2 @if(count($result['filters']['attr_data'])==$key+1) last @endif><a href="#{{$attr_data['option']['name']}}-{{$key}}" data-toggle='collapse' role='button' aria-expanded='false'> {{$attr_data['option']['name']}}</a> </h2>
                       <div class="sub-manu collapse multi-collapse" id="{{$attr_data['option']['name']}}-{{$key}}">
                       <div class="block">
                                <div class="card-body">
              ...
              <div class="range-slider-main">
                  <a class=" main-manu" data-toggle="collapse" href="#brands" role="button" aria-expanded="false" aria-controls="men-cloth">
                    @lang('website.Brands')   
                  </a>
                  <div class="sub-manu collapse multi-collapse" id="brands">
