        ...
        <div class="col-12 col-md-6 col-lg-3">
          <div class="footer-block">
              <div class="single-footer single-footer-left">
                ...
                <li> <a href="{{ URL::to('/become-vendor')}}"><i class="fa fa-angle-right"></i>@lang('website.Vendor')</a> </li>
                <li> <a href="{{ URL::to('/list-shop')}}"><i class="fa fa-angle-right"></i>@lang('website.Shop List')</a> </li>
                </ul>
              </div>
            ...
            <div class="row align-items-center">
                <div class="col-12">
                  <div class="footer-info">
                    © <a href="{{ config('app.app_url', 'Laravel') }}" target="_blank">{{ config('app.app_url_title', 'Laravel') }}.  <a href="{{url('/page?name=refund-policy')}}">@lang('website.Privacy')</a>&nbsp;&bull;&nbsp;<a href="{{url('/page?name=term-services')}}">@lang('website.Terms')</a>
                  </div>
