                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-4">
                          <div class="footer-info">
                              <p>© <a href="{{ config('app.app_url', 'Laravel') }}" target="_blank">{{ config('app.app_url_title', 'Laravel') }}.  <a href="{{url('/page?name=refund-policy')}}">@lang('website.Privacy')</a>&nbsp;&bull;&nbsp;<a href="{{url('/page?name=term-services')}}">@lang('website.Terms')</a></p>
                          </div>
                        </div>
                  </div>
                  </div>
