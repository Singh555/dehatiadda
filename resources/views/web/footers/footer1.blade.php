          ...
          <div class="col-12 col-lg-2">
              ...
              <div class="single-footer single-footer-left">
                ...
                <ul class="links-list pl-0">
                  ...
                  <li> <a href="{{ URL::to('/become-vendor')}}" data-toggle="tooltip" data-placement="left" title="@lang('website.Vendor')"><i class="fa fa-angle-right"></i>@lang('website.Vendor')</a> </li>        
                </ul>
              </div>
        </div>
        <div class="col-12 col-lg-2">
          ...
          <div class="row align-items-center">
              <div class="col-12">
                <div class="footer-info">
                    ©&nbsp;<a href="{{ config('app.app_url', 'Laravel') }}" target="_blank">{{ config('app.app_url_title', 'Laravel') }} <a href="{{url('/page?name=refund-policy')}}">@lang('website.Privacy')</a>
                    &nbsp;•&nbsp;
