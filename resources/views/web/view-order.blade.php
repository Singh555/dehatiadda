        ...
        <div class="row">
          ...
          <div class="table-responsive ">
              <table class="table order-table">
                ...
                <td>
                  {{Session::get('symbol_left')}} {{ $result['orders'][0]->order_price }}
                  </td>
              </tr>
                  <tr>
                <th>{{ trans('labels.Tax') }}:</th>
                <td>
                 {{Session::get('symbol_left')}} {{ $result['orders'][0]->total_tax }}
                  </td>
              </tr>
              <tr>
                <th>{{ trans('labels.ShippingCost') }}:</th>
                <td>
                  {{Session::get('symbol_left')}}  {{ $result['orders'][0]->shipping_cost }}
                  </td>
              </tr>
              @if(!empty($data['orders'][0]->coupon_code))
              <tr>
                <th>{{ trans('labels.DicountCoupon') }}:</th>
                <td>                  
                  {{Session::get('symbol_left')}} {{ $result['orders'][0]->coupon_amount }}</td>
              </tr>
              @endif
              <tr>
                <th>{{ trans('labels.Total') }}:</th>
                <td>
                  {{Session::get('symbol_left')}} {{ $result['orders'][0]->net_amount }}</td>
                  </td>
              </tr>
              </table>
          </div>
