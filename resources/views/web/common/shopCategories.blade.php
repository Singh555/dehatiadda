<?php
 ...
 function shopRecursivecategories(){
  $items = DB::table('categories')
      ...
      ->select('categories.categories_id', 'categories.categories_slug as slug', 'categories.categories_icon_url as path', 'categories_description.categories_name', 'categories.parent_id', 'categories.categories_status')
