...
//send Otp for normal user signup
Route::post('/normalSignup', 'CustomersController@normalSignup');
//verify otp for normal user signup and login after account creation
Route::post('/normalSignup/verify', 'CustomersController@normalSignupVerify');
//validate Referral Code 
Route::post('/referralCode/validate', 'CustomersController@validateReferralCodeAjax');
//send Otp for prime user signup
Route::post('/primeSignup', 'CustomersController@primeSignup');
//verify otp for prime user signup and login after account creation
Route::post('/primeSignup/verify', 'CustomersController@primeSignupVerify');
//send otp for login
Route::post('/login/sendOtp', 'CustomersController@usualLoginSendOtpAjax');
//verify otp and login
Route::post('/login/verifyOtp', 'CustomersController@verifyLogin');
...
Route::group(['namespace' => 'Web','middleware' => $middleware], function () {
	...
	// route for to show payment form using get method
		...
		Route::get('/deleteCart', 'CartController@deleteCart')->middleware('Customer');
		Route::get('/viewcart', 'CartController@viewcart')->middleware('Customer');
		Route::get('/editcart/{id}/{slug}', 'CartController@editcart')->middleware('Customer');
		Route::post('/updateCart', 'CartController@updateCart')->middleware('Customer');
		Route::post('/updatesinglecart', 'CartController@updatesinglecart')->middleware('Customer');
		Route::get('/cartButton', 'CartController@cartButton')->middleware('Customer');
		...
		Route::get('/guest_checkout', 'OrdersController@guest_checkout')->middleware('Customer');
		...
		Route::get('/thankyou', 'OrdersController@thankyou')->middleware('Customer')->name('payment_thankyou');
		...
		Route::any('/subscribeMail', 'IndexController@subscribeMail');
		Route::get('/setSession', 'IndexController@setSession');
                
                //vendor module
                Route::get('/become-vendor', 'VendorsController@signup');
                Route::post('/register-new-vendor', 'VendorsController@signupProcess')->name('vendor.register');
                
                //shop module
                 Route::get('/list-shop', 'ShopController@viewForm');
                Route::post('/register-new-shop', 'ShopController@save')->name('shop.register');
